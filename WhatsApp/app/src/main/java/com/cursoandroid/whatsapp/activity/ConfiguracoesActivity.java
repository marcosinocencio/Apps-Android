...
public class ConfiguracoesActivity extends AppCompatActivity {
            ...
            try{
                switch (requestCode){
                    ...
                    case SELECAO_GALERIA:
                        ...
                        bitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), localDaImagem);
                        break;
                }
    ...
    public void alertaValidacaoPermissao(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this)
                ...
                .setMessage("Para utilizar esse app é necessário aceitar as permissões")
                .setCancelable(false)
    ...
    public void salvarNomeUsuario(View view){
        if(!editPerfilNome.getText().toString().equals("")){
            if(UsuarioFirebase.atualizarNomeUsuario(editPerfilNome.getText().toString())) {

                usuarioLogado.setNome(editPerfilNome.getText().toString());
                usuarioLogado.atualizar();
