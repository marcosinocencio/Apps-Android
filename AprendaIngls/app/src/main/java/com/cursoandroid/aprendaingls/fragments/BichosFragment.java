...
public class BichosFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cao = view.findViewById(R.id.imageButton);
        gato = view.findViewById(R.id.imageButton2);
        leao = view.findViewById(R.id.imageButton3);
        macaco = view.findViewById(R.id.imageButton4);
        ovelha = view.findViewById(R.id.imageButton5);
        vaca = view.findViewById(R.id.imageButton6);
